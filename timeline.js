...
class CanvasManager {
    ...
    handleMouseDown(event) {
        const pos = this.getCanvasMousePos(this.canvas, event);
    ...
    handleMouseMove(event) {
        ...
        if (this.isDragging && this.selectedElement) {
            ...
            this.eventEmitter.emit('elementUpdated', this.selectedElement);
        }
    ...
    handleWheel(event) {
        ...
        const newZoom = this.clamp(this.zoom * delta, 0.1, 5);
        ...
        if (newZoom !== this.zoom) {
            ...
            // Update zoom display
            this.eventEmitter.emit('zoomChanged', this.zoom);
        }
    }
    ...
    addElement(elementData) {
        ...
        this.eventEmitter.emit('elementAdded', element);
    ...
    removeElement(elementId) {
        ...
        if (element) {
            ...
            this.needsRedraw = true;
            this.eventEmitter.emit('elementRemoved', element);
        }
    }
    ...
    selectElement(element) {
        ...
        this.needsRedraw = true;
        this.eventEmitter.emit('elementSelected', element);
    }
    ...
    updateElement(elementId, updates) {
        ...
        if (element) {
            ...
            this.needsRedraw = true;
            this.eventEmitter.emit('elementUpdated', element);
        }
    }
    ...
    setZoom(zoom) {
        this.zoom = this.clamp(zoom, 0.1, 5);
        this.needsRedraw = true;
        this.eventEmitter.emit('zoomChanged', this.zoom);
    }
    ...
    clear() {
        ...
        this.selectedElement = null;
        this.needsRedraw = true;
        this.eventEmitter.emit('canvasCleared');
    }
    ...
    loadCanvasData(data) {
        ...
        this.needsRedraw = true;
        this.eventEmitter.emit('canvasLoaded', data);
    }
    
    // Helper functions
    getCanvasMousePos(canvas, event) {
...
// Assuming eventEmitter is defined elsewhere
const eventEmitter = {
